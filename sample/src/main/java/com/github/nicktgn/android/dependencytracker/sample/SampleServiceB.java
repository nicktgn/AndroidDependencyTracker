...
public class SampleServiceB extends DependencyTrackingService<SampleDependencyTrackerB> {

    private static final String TAG = "SampleServiceB";

    @Override
    public SampleDependencyTrackerB getDependencyTracker() {
        return new SampleDependencyTrackerB(this);
    }
